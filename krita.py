...
if not os.path.isdir('/usr/local/include/immer'):
...
if not os.path.isdir('/usr/local/include/lager'):
	cmd = ['cmake', os.path.abspath('./lager'), '-Dlager_BUILD_TESTS=off', '-Dlager_BUILD_EXAMPLES=off']
	print(cmd)
